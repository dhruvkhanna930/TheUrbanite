...
from urbanite.settings.base import AUTH_USER_MODEL
...
class Rating(TimeStampedUUIDModel):
    ...
    rating = models.IntegerField(verbose_name=_("Rating"), choices=Range.choices, help_text="1=Poor 2=Fair 3=Very Good 4=Very Good 5=Excellent")
